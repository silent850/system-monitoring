...
import { ShieldAlert, ShieldCheck, Activity, Globe, RefreshCcw, Download } from 'lucide-react';
import { UptimeLog } from '../types';
import { generateUptimePDF } from '../utils/pdf';
...
export default function Dashboard({ logs }: { logs: UptimeLog[] }) {
  ...
  const handleDownloadPDF = () => {
    generateUptimePDF(logs, {
      systemName: config.systemName,
      companyName: config.companyName,
      reportTitle: 'Uptime Activity Report'
    });
  };
